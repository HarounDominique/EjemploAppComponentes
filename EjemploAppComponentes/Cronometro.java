...
public class Cronometro extends JLabel implements Serializable {
    ...
    public void addCronometroEventListener(ICronometroEventListener listener) {
    ...
    public void setContador(Boolean contador) {
        ...
        while (li.hasNext()) {
            if (this.contador)
                ((ICronometroEventListener) li.next()).StartCronometro(new CronometroEventObject(this));
            else
                ((ICronometroEventListener) li.next()).StopCronometro(new CronometroEventObject(this));
        }
    }
